...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gcm_device', (
            ...
            ('reg_id', self.gf('django.db.models.fields.TextField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('gcm', ['Device'])

    def backwards(self, orm):
        # Deleting model 'Device'
        db.delete_table('gcm_device')
    ...
    models = {
        ...
        'gcm.device': {
            ...
            'reg_id': ('django.db.models.fields.TextField', [], {}),
